...
Unless the change is trivial such as a type, please [open an issue first](https://github.com/gr2m/node-net-interceptor/issues/new) before starting a pull request for a bug fix or a new feature.
